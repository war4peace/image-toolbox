...
- **Legacy scripts:** `setup.ps1` and `remote-image-upscale.ps1` /
  `remote-tag-and-rename.ps1` are from the earlier ComfyUI-based workflow and are
  kept only for reference. The current app does not use them.

...
- `docs/` — `future-features.md` (roadmap + feasibility), `runpod-notes.md`
  (remote-pod upscaling notes), `video-upscaler.md` (design + as-built notes for
  the RunPod-only Video Upscaler, future-features #2, now shipped/experimental),
  `improvement-recommendations.md` (the codebase-review work plan), `Benchmarks.csv`
